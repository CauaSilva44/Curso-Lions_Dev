import AgendamentoRepository from "../repositories/agendamentos.repository.js";
...
async function listarAgendamentos() {
    const agendamento = await AgendamentoRepository.listar();
    return agendamento;
};
...
async function atualizarAgendamentos() {
    const agendamento = await AgendamentoRepository.atualizar();
    return agendamento;
};
